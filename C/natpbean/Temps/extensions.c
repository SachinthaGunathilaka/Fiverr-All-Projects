...
//        printf("n => *%d* ", state->cells[neighbor_pos]);
//        printf("t : %d, ", type);
...
//    }
//    int cur_x, cur_y;
//    pos_get_coords(state->pos[state->last_color], &cur_x, &cur_y);
//
////    printf("%d\n", game_num_free_coords(info, state, cur_x, cur_y));
//    if(game_num_free_coords(info, state, cur_x, cur_y) == 1)
//        return 1;
//    return 0;
