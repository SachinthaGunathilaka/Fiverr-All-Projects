...
public class BasicTests {
	...
	public void testSpeed() throws Exception {
		String results = runMain(
				new String[] { "--log=speed_test.log", "--covid=covid_data.json", "--properties=downsampled_properties.csv", "--population=population.csv" }, "2\n0\n");
	...
	public void testTwice() throws Exception {
		String result1 = runMain(new String[] { "--covid=covid_data.json", "--properties_properties.csv", "--log=small_test1.log" }, "3\nfull\n2021-11-05\n0\n");
