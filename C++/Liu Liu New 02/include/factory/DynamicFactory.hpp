...
//     header files.
//
// This will be useful for allowing students to supply their own
...
// DYNAMIC_FACTORY_REGISTER.  It's important to understand that this
...
//         factory::DynamicFactory<MazeGenerator>
