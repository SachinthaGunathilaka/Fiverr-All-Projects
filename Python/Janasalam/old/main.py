...
def readStates(filename):
    ...
    for line in lines:
        ...
        data = line.split(",")
        states[data[0]] = [data[1], int(data[2])]
...
def displayStates(states):
    print("+----------------------------------------------------------+")
    print("| {:<15}| {:<20}| {:<15} |".format("State", "Capital", "Population"))
    print("+----------------------------------------------------------+")

    for key, value in sorted(states.items()):
        print("| {:<15}| {:<20}| {:<15} |".format(key, value[0], value[1]))
...
def displayStateDetails(state, state_data):
    ...
    print("| {:<15}| {:<20}| {:<15} |".format(state, state_data[0], state_data[1]))
    print("+----------------------------------------------------------+")
