...
class SudokuSolver():
    ...
    def solve(self, puzzle):
        ...
        if puzzle.is_solved():
            for i in range(9):
                for j in range(9):
                    result[i][j] = puzzle.values[self.boxes[i * 9 + j]]
...
if __name__ == '__main__':
    ...
    # solver = SudokuSolver()
    # p1_str = "...6..2.......9.6..8...5..31..4..9..83........2...6.......6....25.3.7.9...1....84"
    # sudoku1 = Sudoku(p1_str)
    # solver.solve(sudoku1, True)
    ...
    start_time = time.time()
    solver = SudokuSolver()
    sudoku1 = Sudoku(matrix)
    result = solver.solve(sudoku1)
    print(result)
    # print("--- %s seconds ---" % (time.time() - start_time))
